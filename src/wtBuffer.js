...
class wtBuffer extends wtResource {
    ...
    {
        this.usage_ = bufferUsage.Uniform | bufferUsage.CopyDst;// | bufferUsage.MapWrite;
        this.sizeInBytes_ = sizeInBytes;
        let bufferDescriptor = {
            size: this.sizeInBytes_,
            usage: this.usage_
    ...
    getSizeInBytes(){return this.sizeInBytes_;}

    async mapBuffer() // Todo how does this work?
    {
